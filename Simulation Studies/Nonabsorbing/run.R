...
simulation <- function(run, data_gen="OMTM1"){
  ...
  if (file.exists("data-complete")){
    save(dat, file = paste0("data-complete/data-", run, ".RData"))}
  ...
  vcov.bmtm <- mdl.bmtm$vcov[1:5, 1:5]
  ...
  vcov.bmtm.noX <- mdl.bmtm.noX$vcov[1:4, 1:4]
  ...
  ##### GLMO1 #####
  # Fit GLMO1 model and extract coefficients, covariance matrix
  ...
  ##### GLMO2 #####
  # Fit GLMO2 model and extract coefficients, covariance matrix
  ...
  ##### GLMO3 #####
  # Fit GLMO3 model and extract coefficients, covariance matrix
  ...
  vcov.omtm1 <- mdl.omtm1$vcov[1:15, 1:15]
  ...
  names(coefs.omtm1.noX) <- c("est.a1", "est.a2", "est.a3",
                              ...
                              "est.g21", "est.g22", "est.g23",
                              "est.g31", "est.g32", "est.g33")
  vcov.omtm1.noX <- mdl.omtm1.noX$vcov[1:14, 1:14]
  ...
  names(coefs.omtm2) <- c("est.a1", "est.a2", "est.a3",
                          ...
                          "est.g21", "est.g22", "est.g23",
                          "est.g31", "est.g32", "est.g33")
  vcov.omtm2 <- mdl.omtm2$vcov[1:16, 1:16]
  ...
  names(coefs.omtm2.noX) <- c("est.a1", "est.a2", "est.a3",
                              ...
                              "est.g21", "est.g22", "est.g23",
                              "est.g31", "est.g32", "est.g33")
  vcov.omtm2.noX <- mdl.omtm2.noX$vcov[1:15, 1:15]
  ...
  names(coefs.omtm3) <- c("est.a1", "est.a2", "est.a3",
                          ...
                          "est.g21", "est.g22", "est.g23",
                          "est.g31", "est.g32", "est.g33")
  vcov.omtm3 <- mdl.omtm3$vcov[1:17, 1:17]
  ...
  names(coefs.omtm3.noX) <- c("est.a1", "est.a2", "est.a3",
                              ...
                              "est.g21", "est.g22", "est.g23",
                              "est.g31", "est.g32", "est.g33")
  vcov.omtm3.noX <- mdl.omtm3.noX$vcov[1:16, 1:16]
  ...
  if (file.exists("output-complete")){
    save(sim1rst, file = paste0("output-complete/sim1-run-", run, ".RData"))}
  # RD
  sim2rst <- data.frame(
    data_gen = data_gen,
    fu       = "Complete",
