...
To be able to reproduce the results one would need the original data from the CLOVERS study and run the code in `oddsratio28days.R` and `riskdifference.R`.
